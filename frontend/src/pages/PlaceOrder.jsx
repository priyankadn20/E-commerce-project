      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "bkash" ? "bg-green-500" : ""}`}
              ></p>
            ...
            >
              <p
                className={`min-w-3.5 h-3.5 border rounded-full ${method === "nagad" ? "bg-green-500" : ""}`}
              ></p>
              <img className="h-5 mx-4" src={assets.nagad_logo} alt="" />
            </div>
            <div
              onClick={() => setMethod("cod")}
              className="flex items-center gap-2 border p-2 px-2 cursor-pointer"
            >
              <p
